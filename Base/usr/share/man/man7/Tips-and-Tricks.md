...
-   Enter a URL to open it in the web browser, e.g. `silk-project.github.io`.
...
-   Many SilkOS applications already have convenient aliases. Use `$ cat /etc/shellrc` to view them.
