...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    auto show_users_action = GUI::Action::create_checkable(
        "Show SerenityOS &users", TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/silkball.png"sv)), [&map_widget](auto& action) { map_widget.set_show_users(action.is_checked()); }, window);
